...
var swiper = new Swiper(".mySwiper", {
  ...
  pagination: {
    el: ".swiper-pagination", // This ensures the dots appear
...
$(document).ready(function() {
  ...
  $(".second-carousel").owlCarousel({
      ...
      nav: true,       
      dots: true, 
      dotsEach: 1, // Ensure each dot corresponds to one item
...
//     loop: true, // Optional: if you want looping, enable this
//     margin: 20, // Set the margin between items
//     nav: true,  // Show next/previous navigation buttons
//     dots: true, // Show dots
//     dotsEach: 1, // Ensure each dot corresponds to one item
//     slideBy: 1, // Move only one item at a time
//     navText: [
...
$(".fourth-carousel").owlCarousel({
  ...
  // autoplay: true,
  dotsEach: 1, // Ensure each dot corresponds to one item
  slideBy: 2, // Move only one item at a time
  navText: [
      "<div>&#8592;</div>", 
      "<div>&#8594;</div>"
  ],
...
let lastScrollTop = 0;
let header = document.querySelector(".head-second");
...
window.addEventListener("scroll", function () {
    ...
    if (scrollTop > lastScrollTop) {
        ...
        header.style.top = "-100px"; // Adjust this based on header height
    } else {
        // Scrolling Up - Show & Fix Header
        header.style.position = "fixed";
        header.style.top = "0";
        header.style.width = "100%"; // Ensures full width when fixed
